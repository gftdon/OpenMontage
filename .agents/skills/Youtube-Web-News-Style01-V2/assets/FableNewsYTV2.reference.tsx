// SNAPSHOT of remotion-composer/src/FableNewsYTV2.tsx (engine) taken 2026-09-03 for skill Youtube-Web-News-Style01-V2 — the live file wins if they differ.
...
import { CAPTION_PAGES, type CaptionPage } from "./fableNewsCaptions";
import { WEB_CLIPS } from "./fableNewsWeb";
import {
...
} from "./fableNewsEpisodeV2";

// ===========================================================================
// FableNewsYTV2 — 16:9 AI-news report ENGINE (1920x1080@25)
...
// Episode data (beats, copy, timeline) lives in fableNewsEpisodeV2.ts.
// ===========================================================================
...
// Root composition
// ===========================================================================
export type FableNewsYTV2Props = { durationSec?: number };

export const calculateFableNewsYTV2Metadata: CalculateMetadataFunction<FableNewsYTV2Props> = ({ props }) => {
  const fps = 25;
...
export const FableNewsYTV2: React.FC<FableNewsYTV2Props> = ({ durationSec = TOTAL_DURATION_SEC }) => {
  useThaiFonts();
  const frame = useCurrentFrame();
...
// ===========================================================================
export type FableNewsThumbProps = { variant?: string; avatarSec?: number };
export const FableNewsThumb: React.FC<FableNewsThumbProps> = ({ variant = "A", avatarSec = 3.0 }) => {
  useThaiFonts();
  const { fps } = useVideoConfig();
