...
import { CAPTION_PAGES, type CaptionPage } from "./aiAgencyCaptions";
import { WEB_CLIPS } from "./aiAgencyWeb";
import {
...
} from "./aiAgencyNewsEpisodeV2";

// ===========================================================================
// AiAgencyNewsYTV2 — 16:9 AI-news report ENGINE (1920x1080@25)
...
// Episode data (beats, copy, timeline) lives in aiAgencyNewsEpisodeV2.ts.
// ===========================================================================
...
// Root composition
// ===========================================================================
export type AiAgencyNewsYTV2Props = { durationSec?: number };

export const calculateAiAgencyNewsYTV2Metadata: CalculateMetadataFunction<AiAgencyNewsYTV2Props> = ({ props }) => {
  const fps = 25;
...
export const AiAgencyNewsYTV2: React.FC<AiAgencyNewsYTV2Props> = ({ durationSec = TOTAL_DURATION_SEC }) => {
  useThaiFonts();
  const frame = useCurrentFrame();
...
// ===========================================================================
export type AiAgencyNewsThumbProps = { variant?: string; avatarSec?: number };
export const AiAgencyNewsThumb: React.FC<AiAgencyNewsThumbProps> = ({ variant = "A", avatarSec = 3.0 }) => {
  useThaiFonts();
  const { fps } = useVideoConfig();
