...
import { CAPTION_PAGES, type CaptionPage } from "./tripoGameCaptions";
import { WEB_CLIPS } from "./tripoGameWeb";
import {
...
} from "./tripoGameEpisodeV2";

// ===========================================================================
// TripoGameNewsYTV2 — 16:9 AI-news report ENGINE (1920x1080@25)
...
// Episode data (beats, copy, timeline) lives in tripoGameEpisodeV2.ts.
// ===========================================================================
...
// Root composition
// ===========================================================================
export type TripoGameNewsYTV2Props = { durationSec?: number };

export const calculateTripoGameNewsYTV2Metadata: CalculateMetadataFunction<TripoGameNewsYTV2Props> = ({ props }) => {
  const fps = 25;
...
export const TripoGameNewsYTV2: React.FC<TripoGameNewsYTV2Props> = ({ durationSec = TOTAL_DURATION_SEC }) => {
  useThaiFonts();
  const frame = useCurrentFrame();
...
// ===========================================================================
export type TripoGameNewsThumbProps = { variant?: string; avatarSec?: number };
export const TripoGameNewsThumb: React.FC<TripoGameNewsThumbProps> = ({ variant = "A", avatarSec = 3.0 }) => {
  useThaiFonts();
  const { fps } = useVideoConfig();
