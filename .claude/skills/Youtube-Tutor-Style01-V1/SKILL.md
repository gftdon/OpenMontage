...
python3 .claude/skills/Youtube-Tutor-Style01-V1/scripts/srt_to_script.py \
...
python3 .claude/skills/karaoke_subtitle_v2/scripts/repage.py \
...
```bash
python3 .claude/skills/Youtube-Tutor-Style01-V1/scripts/line_starts.py \
...
```bash
.claude/skills/Youtube-Tutor-Style01-V1/scripts/mux_av.sh \
