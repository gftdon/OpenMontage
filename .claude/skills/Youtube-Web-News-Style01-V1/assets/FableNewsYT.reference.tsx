// SNAPSHOT of remotion-composer/src/FableNewsYT.tsx (reference implementation of this format, 2026-09-03).
// Prefer cloning the live file from remotion-composer/src/; this copy exists so the skill survives repo changes.
// Swap per episode (see SKILL.md Step 7): names, the two data imports, VO_END_SEC/TOTAL_DURATION_SEC, AV_CX,
// the EPISODE block (all on-screen strings), BROLL_DUR, BEATS, SUMMARY3/FINAL4/VS/CTA_T.
